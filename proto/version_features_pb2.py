...
_VERSION_FEATURES = DESCRIPTOR.message_types_by_name['Version_Features']
Version_Features = _reflection.GeneratedProtocolMessageType('Version_Features', (_message.Message,), {
  'DESCRIPTOR' : _VERSION_FEATURES,
  '__module__' : 'version_features_pb2'
  # @@protoc_insertion_point(class_scope:Version_Features)
  })
_sym_db.RegisterMessage(Version_Features)
